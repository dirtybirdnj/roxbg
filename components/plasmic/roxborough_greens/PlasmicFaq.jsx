...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: QhVGM4DbWBIt/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fpZhV)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___0Oxb)}>
          <div className={classNames(projectcss.all, sty.freeBox__ulV1O)}>
            {p.renderPlasmicSlot({

...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Mrk7UJLJOd-F/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: 8qi_tbW2QVX3/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 94zizn_MY4hX/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__syRHz)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__dlt7A)}
                role={"img"}
              />
            ),
